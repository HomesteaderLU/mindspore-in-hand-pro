...
import com.mindspore.custommodel.StyleClassifierFragment;
...
public class FragmentFactory {
    ...
    private StyleClassifierFragment mStyleClassifierFragment;
    ...
    public StyleClassifierFragment getStyleClassifierFragment() {
        if (mStyleClassifierFragment == null) {
            synchronized (FragmentFactory.class) {
                if (mStyleClassifierFragment == null) {
                    mStyleClassifierFragment = new StyleClassifierFragment();
                }
            }
        }
        return mStyleClassifierFragment;
    }
}
